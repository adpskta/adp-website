...
- **2026年8月16日 = Squarespace契約更新日**。これまでにDNS切替→Squarespace解約
...
- Home: hero「anhelo de plantas」＋ポジショニング1行＋哲学文＋署名（丸写真＋代表名）＋Selected Works 6件＋CTA（経歴はAboutへ一本化）
...
- トップのタグライン（hero直下のキャッチ）は入れない（坂田さん指示）
- 返信目安は「1週間以内」
